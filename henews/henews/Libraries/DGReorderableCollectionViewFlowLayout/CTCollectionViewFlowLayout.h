...
@interface CTCollectionViewFlowLayout : UICollectionViewFlowLayout <UIGestureRecognizerDelegate>
...
@protocol CTCollectionViewDataSource <UICollectionViewDataSource>
