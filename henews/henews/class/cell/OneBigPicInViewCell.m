...
@implementation OneBigPicInViewCell
...
{
    static NSString *identifier = @"OneBigPicInViewCell";
    // 1.缓存中取
    OneBigPicInViewCell *cell = [tableView dequeueReusableCellWithIdentifier:identifier];
    // 2.创建
    if (cell == nil) {
        cell = [[OneBigPicInViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:identifier];
    }
    return cell;
}
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        UIImageView *playIcon = [[UIImageView alloc]initWithFrame:CGRectMake(SCREEN_WIDTH-20.5f-16.0f, 217-42.0f-14.0f, 20.5f, 14.0f)];
        playIcon.image = [UIImage imageNamed:@"picIconNew.png"];
